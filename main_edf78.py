...
def main(params, intra_mask_ratio, inter_mask_ratio):
    ...
    for fold_num in range(len(folds)):
        ...
        train_iter, test_iter = load_dataloader(data_train, data_test, label_train, label_test, transition_train,
                                                transition_test, batch_size=64, seed=2025)
        ...
        model_path = 'model/EDF78_intra_mask{}_enc{}_inter_mask{}_length{}_step{}/Classifier_ft_fold{}_acc{}.pth'.format(
...
def parse_args():
    ...
    Returns:
        args: 解析后的参数对象
    """
    parser = argparse.ArgumentParser(description='SleepMAE Training for EDF78 Dataset')
